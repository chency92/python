...
if __name__ == "__main__":
    ...
    x = Rrequests("post", url= base_url + "/api/open/v1/manager/device/add",
                  json={"phone":"望天7","mac":"805EC0484B28","modelId":"740b5620916a4d0a9a45171630076528","regionId":"e89adb4d568c4c4fb474832953d57904","staffIds":None,"staffs":None,"id":None,"machineId":"2152018111201473"})
    r = x.send()
    # print(r.json())
